...
export default function PublicProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center justify-between py-12 px-4 sm:px-6 selection:bg-indigo-500 selection:text-white">
      ...
      {/* Footer */}
      <footer className="mt-16 pt-8 border-t border-slate-900 w-full text-center text-xs text-slate-500">
        ReFlow Media Kit & Sales Hub • Diseñado por BI LABS - Costa Rica
      </footer>
    </div>
  );
}
