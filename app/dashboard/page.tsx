...
import { 
  ...
  ExternalLink, Plus, Trash2, Edit3, CheckCircle, RefreshCw, Smartphone, Share2, MessageSquare, ShieldAlert, CreditCard, Sparkles, Image as ImageIcon
} from 'lucide-react';
        ...
        {activeTab === 'profile' && (
          <div className="max-w-4xl space-y-8 animate-fadeIn">
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1">Configura tu foto, identidad profesional y conecta tus cuentas de creador.</p>
            </div>
              ...
              <form onSubmit={handleProfileSave} className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6 p-6 rounded-2xl bg-slate-950 border border-slate-800">
                  ...
                  <div className="flex-1 w-full space-y-2">
                    <label className="block text-xs font-semibold uppercase tracking-wider text-slate-400">URL de la Foto de Perfil (Imagen)</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-slate-900 border border-slate-800 rounded-xl text-white text-xs focus:outline-none focus:border-indigo-500"
                      />
                    </div>
                    <p className="text-[11px] text-slate-500">Pega el enlace directo de una imagen (ej. de Unsplash, Imgur o tu CDN).</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6 p-6 rounded-2xl bg-gradient-to-r from-indigo-950/50 to-purple-950/50 border border-indigo-500/30">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-2xl font-black text-white">Plan Gratuito (Freemium)</h3>
                    <p className="text-xs text-slate-300 mt-1">Actualiza a Pro para desbloquear analíticas avanzadas y descargas ilimitadas de Media Kit.</p>
                  </div>
                </div>
                <span className="px-4 py-2 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-400 text-xs font-bold flex items-center gap-1.5">
                  Plan Inicial
                </span>
              </div>
